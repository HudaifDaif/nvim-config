...
-- NOTE: NvimTree setup requiring disable of netrw and setting 24 bit colour (optional)
        ...
        config = function()
            ...
            vim.api.nvim_create_autocmd('LspAttach', {
                ...
                callback = function(event)
                    ...
                    -- Bring up tooltip of any definition or documentation for the symbol under cursor.
                    map('<leader>i', vim.lsp.buf.hover, 'Symbol [I]nformation')
...
-- Set up diagnostic icons for nvim-tree
